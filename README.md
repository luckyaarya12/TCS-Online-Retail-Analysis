...
### Dashboard Delivery
The core deliverable was a suite of **Power BI dashboards** focused on **CEO/CMO views**. Analysis covered key areas like Monthly Revenue Trends and Top Customer/Geographic Performance.

### Data Integrity (Power Query)
**Critical data cleaning** was performed in **Power Query** to ensure data reliability. This transformation included filtering for valid transactions (**Quantity $\ge 1$** and **Unit Price $ > 0$**). The exact cleaning steps are documented in **`# Data Transformation and Cleaning Logic.md`**.
...
## 📁 Files Included
* **`Online_Retail_Dashboard_Analysis.pbix`**: Working Power BI source file (for technical review).
* **`Online_Retail_Dashboard_Analysis.pdf`**: **PDF export of the final dashboards (for non-technical viewing).**
